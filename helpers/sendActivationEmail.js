...
async function sendActivationLink(req, res, next, email) {
    try {
        ...
        const emailOptions = {
            ...
            bcc: '',
            subject:
                'Dinshaws Software User Registered - Please Activate your account',
            text: `<h2>You are now registered with Dinshaws Software.</h2><br>Please activate your account.<br><br><a style="background: rgb(246, 165, 236); color: black; padding: 1em 4em;text-decoration:none; border-radius: 10px" href="${host.PROTOCOL}://${host.HOST}:${host.PORT}/users/activate/${token}"> Activate by clicking here.</a>.<br><br>The link is valid only for 2 hours.<br>This link can be used only once.<br><br><strong>Dinshaws Software Team</strong>`,
        };
